...
#define NAME_FILTER_LEN_MAX 20
	...
	int btshell_get_first_conn(uint16_t *conn_handle);
	...
	#define gatt_svr_register_cb btshell_gatt_svr_register_cb
	#define gatt_svr_init btshell_gatt_svr_init

	void gatt_svr_register_cb(struct ble_gatt_register_ctxt *ctxt, void *arg);
	int gatt_svr_init(void);
#ifdef CONFIG_NIMBLE_PTS
    int gatt_svr_init_small_db(void);
	int gatt_svr_init_large_db1(void);
	void gatt_svr_large_db1_author(uint8_t enable);
#endif
