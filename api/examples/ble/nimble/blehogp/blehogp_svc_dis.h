...
#ifndef H_BLEHOGP_SVC_DIS_
#define H_BLEHOGp_SVC_DIS_
 ...
 *    }
 *    blehogp_svc_dis_manufacturer_name_set("MyNewt");
 *    blehogp_svc_dis_firmware_revision_set(firmware_revision);
 *
 */
...
struct blehogp_svc_dis_data {
    ...
    /**
     * PNP Info
     * Represent vendor id source, vendor id, product id, product version
     */
    const char *pnp_info;
};
 ...
 */
extern struct blehogp_svc_dis_data blehogp_svc_dis_data;

void blehogp_svc_dis_init(void);

const char *blehogp_svc_dis_model_number(void);
int blehogp_svc_dis_model_number_set(const char *value);
const char *blehogp_svc_dis_serial_number(void);
int blehogp_svc_dis_serial_number_set(const char *value);
const char *blehogp_svc_dis_firmware_revision(void);
int blehogp_svc_dis_firmware_revision_set(const char *value);
const char *blehogp_svc_dis_hardware_revision(void);
int blehogp_svc_dis_hardware_revision_set(const char *value);
const char *blehogp_svc_dis_software_revision(void);
int blehogp_svc_dis_software_revision_set(const char *value);
const char *blehogp_svc_dis_manufacturer_name(void);
int blehogp_svc_dis_manufacturer_name_set(const char *value);
const char *blehogp_svc_dis_system_id(void);
int blehogp_svc_dis_system_id_set(const char *value);
