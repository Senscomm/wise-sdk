...
#ifdef CONFIG_PCF8563LX
static declare_device_single(rtc, 3) = {
    .name = "pcf85631lx",
    .io.bus = "atci2c.1"
};
#endif
...
/*
 * SCM2010 QFN40 EVB V1.0 b/d pin assignment
 */
...
void board_init(void)
{
	...
	printk("BOARD: SCM2010 QFN40 EVB\n");
}
