...
#define PHY_AGC_XRC_RSSI_CFG                               0x30C0
/* Gaind adj on XRC rssi high */
#define     PHY_AGC_XRC_HIGH_GDOWN_MASK                      0xff
#define     PHY_AGC_XRC_HIGH_GDOWN_SHIFT                        0
...
/* [6:0] XRC RF Channel index */
/* [8] XRC RF power ON */
/* [12] XRC RF WiFi Datarate (0:20M, 1:40M) */
/* [30:16] TxLDO Prep counter */
/* [31] TxLDO Prep always ON */
#define     RFI_XRC_CONFIG_MASK                        0xffffffff
#define     RFI_XRC_CONFIG_SHIFT                                0

#define FW_RFI_XRC_CFG2                                    0x0008
/* cal-tx-rx-ready-idle */
#define     RFI_XRC_CONFIG2_MASK                        0x1ffffff
#define     RFI_XRC_CONFIG2_SHIFT                               0

#define FW_RFI_LUT_INTFV2_CFG                               0x000C
/* RFI RxLUT new interface enable */
#define     RFI_RXLUT_USE_NEWINTF_MASK                         0x1
#define     RFI_RXLUT_USE_NEWINTF_SHIFT                          0
/* RFI TxLUT new interface enable */
#define     RFI_TXLUT_USE_NEWINTF_MASK                        0x10
#define     RFI_TXLUT_USE_NEWINTF_SHIFT                          4
...
/* RxLUT select */
/* [10] rxdc rf comp [9] rx gain [8] rxdc dig comp */
#define     RFI_RXLUT_SELECT_MASK                            0x700
#define     RFI_RXLUT_SELECT_SHIFT                               8
/* RxLUT mem addr */
#define     RFI_RXLUT_ADDR_MASK                               0x7f
#define     RFI_RXLUT_ADDR_SHIFT                                 0

#define FW_RFI_RXLUTV2_WRDATA                               0x0104
/* RxLUT wr data */
#define     RFI_RXLUT_WRDATA_MASK                       0xffffffff
#define     RFI_RXLUT_WRDATA_SHIFT                               0

#define FW_RFI_RXLUTV2_WRSTART                              0x0108
/* RxLUT wr start */
#define     RFI_RXLUT_WRSTART_MASK                             0x1
#define     RFI_RXLUT_WRSTART_SHIFT                              0

#define FW_RFI_RXLUTV2_RDDATA                               0x010C
/* RxLUT rd data */
#define     RFI_RXLUT_RDDATA_MASK                       0xffffffff
#define     RFI_RXLUT_RDDATA_SHIFT                               0

#define FW_RFI_RXLUTV2_RADDR                                0x0110
/* RxLUT select */
#define     RFI_RXLUT_SEL_RD_MASK                            0x700
...
/* TxLUT select */
/* [12] nl cff 2 [11] nl cff 1 [10] nl cff 0 */
/* [9] tx gain [8] lo comp */
#define     RFI_TXLUT_SELECT_MASK                           0x1f00
#define     RFI_TXLUT_SELECT_SHIFT                               8
/* TxLUT mem addr */
#define     RFI_TXLUT_ADDR_MASK                               0x3f
#define     RFI_TXLUT_ADDR_SHIFT                                 0

#define FW_RFI_TXLUTV2_WRDATA                               0x0124
/* TxLUT wr data */
#define     RFI_TXLUT_WRDATA_MASK                       0xffffffff
#define     RFI_TXLUT_WRDATA_SHIFT                               0
...
#define FW_RFI_TXLUTV2_RDDATA                               0x012C
/* TxLUT rd data */
#define     RFI_TXLUT_RDDATA_MASK                       0xffffffff
#define     RFI_TXLUT_RDDATA_SHIFT                               0

#define FW_RFI_TXLUTV2_RADDR                                0x0130
/* TxLUT select */
#define     RFI_TXLUT_SEL_RD_MASK                           0x1f00
#define     RFI_TXLUT_SEL_RD_SHIFT                               8
/* TxLUT mem addr */
#define     RFI_TXLUT_ADDR_RD_MASK                            0x3f
...
#define PHY_RFI_TX_POLYNL_CFG2                              0x0228
/* Mag output scale. Scale 1 = 8'd 78. */
...
#define PHY_RFI_TRX_CAL_LUT_EN                              0x022C
/* Tx cal use LUT */
#define     TXCAL_USE_LUT_MASK                                 0x1
#define     TXCAL_USE_LUT_SHIFT                                  0
/* Rx cal use LUT */
#define     RXCAL_USE_LUT_MASK                                0x10
#define     RXCAL_USE_LUT_SHIFT                                  4
...
/* 2x interpolation stage enable */
#define     RFITX_2XINTP_ON_MASK                              0x10
#define     RFITX_2XINTP_ON_SHIFT                                4
...
#define PHY_RFI_RXLPF_CFG                                   0x0530
/* Optional LPF */
#define     RFI_RXLPF_EN_MASK                                  0x1
#define     RFI_RXLPF_EN_SHIFT                                   0
/* Output shift bits */
#define     RFI_RXLPF_SFT_MASK                                0x30
#define     RFI_RXLPF_SFT_SHIFT                                  4
/* ACI detection ratio (8'd 64 = 12 dB, linear scale) */
#define     RFI_RXLPF_INTF_RATIO_MASK                       0xff00
#define     RFI_RXLPF_INTF_RATIO_SHIFT                           8
/* ACI detection enable */
#define     RFI_RXLPF_INTF_DETEN_MASK                      0x10000
#define     RFI_RXLPF_INTF_DETEN_SHIFT                          16
/* opbw */
#define     RFI_RXLPF_INTF_OPBW_MASK                      0x300000
#define     RFI_RXLPF_INTF_OPBW_SHIFT                           20

#define FW_RFI_XRC_RSSI_CFG                                0x0540
/* analog RSSI input valid (i,q) */
#define     RFI_XRC_RSSI_INP_VLD_MASK                  0x60000000
#define     RFI_XRC_RSSI_INP_VLD_SHIFT                         29
/* analog ACI detector enable */
#define     RFI_XRC_RSSI_DET_ENA_MASK                  0x10000000
#define     RFI_XRC_RSSI_DET_ENA_SHIFT                         28
/* analog RSSI avg filter cff (0.25, 0.125, ...) */
#define     RFI_XRC_RSSI_AVG_CFF_MASK                   0x7000000
#define     RFI_XRC_RSSI_AVG_CFF_SHIFT                         24
/* analog RSSI input fifo config (same with ADC fifo) */
#define     RFI_XRC_RSSI_FIFO_CFG_MASK                   0xff0000
#define     RFI_XRC_RSSI_FIFO_CFG_SHIFT                        16
/* analog RSSI input detection threshold */
#define     RFI_XRC_RSSI_DET_THRD_MASK                     0xff00
#define     RFI_XRC_RSSI_DET_THRD_SHIFT                         8
/* ACI detection counter */
#define     RFI_XRC_RSSI_DET_CNTR_MASK                       0xff
#define     RFI_XRC_RSSI_DET_CNTR_SHIFT                         0

#define FW_RFI_XRC_RSSI_CFG2                               0x0544
/* RSSI valid delay */
#define     RFI_XRC_RSSI_VLD_DLY_MASK                      0xff00
#define     RFI_XRC_RSSI_VLD_DLY_SHIFT                          8
/* RSSI low detection threshold */
#define     RFI_XRC_RSSI_LOW_THRD_MASK                       0xff
#define     RFI_XRC_RSSI_LOW_THRD_SHIFT                         0

#define FW_RFI_XRC_RSSI_RD                                 0x054C
/* analog RSSI input average result I */
#define     RFI_XRC_RSSI_RES_I_MASK                        0xff00
#define     RFI_XRC_RSSI_RES_I_SHIFT                            8
/* analog RSSI input average result Q */
#define     RFI_XRC_RSSI_RES_Q_MASK                          0xff
#define     RFI_XRC_RSSI_RES_Q_SHIFT                            0
