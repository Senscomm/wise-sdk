...
#define     INTR_ENABLE_RESP_ESP_MASK                                          0x20000
#define     INTR_ENABLE_RESP_ESP_SHIFT                                              17
/* Interrupt enable for rx data doesn’t need response, */
/* this interrupt is only enabled when REG_VIF0{/1}_ESP.sp_check_en is set to 1 */
#define     INTR_ENABLE_RX_ESP_MASK                                            0x40000
#define     INTR_ENABLE_RX_ESP_SHIFT                                                18
...
/* Interrupt enable for send qos null in hetb ppdu when receiving basic trigger */
...
/* Interrupt enable for RX DTIM parser */
#define     INTR_ENABLE_RX_DTIM_MASK                                        0x20000000
#define     INTR_ENABLE_RX_DTIM_SHIFT                                               29
/* Interrupt enable for coex */
/* This interrupt is generated */
/* when tx_abort from PTA goes from high to low */
#define     INTR_ENABLE_COEX_MASK                                           0x40000000
#define     INTR_ENABLE_COEX_SHIFT                                                  30
...
/* more data is 0 for mgmt frame or date frame that is not qos_data and qos null. */
/* the interrupt asserted after response frame send out. */
#define     INTR_CLEAR_RESP_ESP_MASK                                           0x20000
#define     INTR_CLEAR_RESP_ESP_SHIFT                                               17
/* Interrupt clear for rx data doesn’t need response, */
/* the data is  qos null or qos data with eosp is 1, */
/* more data is 0 for mgmt frame or date frame that is not qos_data and qos null. */
/* this interrupt asserted after rx dma is finished. */
#define     INTR_CLEAR_RX_ESP_MASK                                             0x40000
#define     INTR_CLEAR_RX_ESP_SHIFT                                                 18
...
/* Interrupt clear for RX DTIM parser */
#define     INTR_CLEAR_RX_DTIM_MASK                                         0x20000000
#define     INTR_CLEAR_RX_DTIM_SHIFT                                                29
/* Interrupt clear for coex */
/* This interrupt is generated */
/* when tx_abort from PTA goes from high to low */
#define     INTR_CLEAR_COEX_MASK                                            0x40000000
#define     INTR_CLEAR_COEX_SHIFT                                                   30
...
/* this interrupt is only enabled when REG_VIF0{/1}_ESP.sp_check_en is set to 1 */
#define     INTR_STATUS_RESP_ESP_MASK                                          0x20000
#define     INTR_STATUS_RESP_ESP_SHIFT                                              17
...
/* this interrupt is only enabled when REG_VIF0{/1}_ESP.sp_check_en is set to 1 */
#define     INTR_STATUS_RX_ESP_MASK                                            0x40000
#define     INTR_STATUS_RX_ESP_SHIFT                                                18
...
/* Interrupt status for RX DTIM parser */
#define     INTR_STATUS_RX_DTIM_MASK                                        0x20000000
#define     INTR_STATUS_RX_DTIM_SHIFT                                               29
/* Interrupt status for coex */
/* This interrupt is generated */
/* when tx_abort from PTA goes from high to low */
#define     INTR_STATUS_COEX_MASK                                           0x40000000
#define     INTR_STATUS_COEX_SHIFT                                                  30
...
/* Slot time duration */
#define     DEV_CFG_SLOT_TIME_MASK                                                0xfc
#define     DEV_CFG_SLOT_TIME_SHIFT                                                  2
...
/* which qos null is automatically switched. */
...
/* associated uora when do contention */
...
/* this is not explicitly described in the spec, we don't have such test */
...
/* non-ht ppdu only contains 1 symbol pkt delay for us, now simulation is 3.35us */
#define     DEV_OPT1_NONHT_1OFDM_US_DELAY_MASK                                 0x70000
#define     DEV_OPT1_NONHT_1OFDM_US_DELAY_SHIFT                                     16
/* non-ht ppdu only contains 1 symbol pkt delay for cycle, */
...
/* Regard tx_abort from PTA as cca busy */
#define     DEV_CS_BUSY_COEX_MASK                                                 0x20
#define     DEV_CS_BUSY_COEX_SHIFT                                                   5
...
/* if this register is 0, sequence control field in cbf frame is 0 */
...
/* Preamble type in case of transmitting non-HT frame for interface 0 */
...
/* Enable function to limit maximum value for reported SNR0 */
...
/* BSR control subfield content for for HTC he variant, */
/* please referring 11ax D4.2 9.2.4.6a.4 for details */
...
/* before association, can also fill bss_color field to the bss color value we want to associate. */
...
/* enable to supported unassociated AP UORA */
...
/* be queue sequence control field for qosnull frame in HETB, map to queue0 */
...
/* bk queue sequence control field for qosnull frame in HETB, map to queue1 */
...
/* vi queue sequence control field for qosnull frame in HETB, map to queue2 */
...
/* vo queue sequence control field for qosnull frame in HETB, map to queue3 */
...
/* bit [3:0] for for primary 80Mhz, bit [7:4] is for secondary 80Mhz */
...
/* if bit1 is 1'b1, supports masked HE-LTF sequence mode */
...
/* bit [7:6] is the mappding for highest 20Mhze channel in whole 80Mhz */
...
/* phy operation channel is DFS-50-100. */
...
/* disable sequence number increase if send qos null automatically in hetb ppdu */
...
/* resource request buffer threshold exponent for nfrp */
#define     VIF0_TRIG_RESOURCE_THR_EXP_MASK                                       0xff
#define     VIF0_TRIG_RESOURCE_THR_EXP_SHIFT                                         0
/* resource request buffer exponent to compare with */
/* resource request buffer threshold exponent to fill ndp_feedback_status */
...
/* Each bit set to 1, use the monitored one; */
...
/* each 20Mhz channel location in bqr field */
...
/* If this this bit is 1, would enable to generate sp termination interrupt. */
...
#define REG_VIF0_HETB_HIGH_MCS                                                   0x1A8
/* highest MCS for hetb ppdu */
#define     VIF0_HETB_HIGH_MCS_HETB_HIGH_MCS_MASK                                  0xf
#define     VIF0_HETB_HIGH_MCS_HETB_HIGH_MCS_SHIFT                                   0
...
/* Preamble type in case of transmitting non-HT frame for interface 1 */
/* (0 : long preamble, 1 : short preamble) */
...
/* we want to associate. this time keep the COLOR_EN to 0 */
...
/* be queue sequence control field for qosnull frame in HETB, map to queue5 */
...
/* bk queue sequence control field for qosnull frame in HETB, map to queue6 */
...
/* vi queue sequence control field for qosnull frame in HETB, map to queue7 */
...
/* vo queue sequence control field for qosnull frame in HETB, map to queue8 */
...
#define REG_VIF1_HETB_HIGH_MCS                                                   0x2A8
/* highest MCS for hetb ppdu */
#define     VIF1_HETB_HIGH_MCS_HETB_HIGH_MCS_MASK                                  0xf
#define     VIF1_HETB_HIGH_MCS_HETB_HIGH_MCS_SHIFT                                   0
...
/* bit 3 : queue enable for unassociated UORA case to send HE TB response */
...
/* The time durinng which m2p_tx_rf_en signal is set to high */
/* from the time that a last interrupt happens for EDCA */
#define     TX_CFG_RF_EN_TIMER_MASK                                             0x1f00
#define     TX_CFG_RF_EN_TIMER_SHIFT                                                 8
...
/* some times preferred_ac in basic trigger doesn't have pkt to send */
...
/* Enable RX operation, */
/* 0 : disable RX operation immediately, 1 : enable RX operation */
...
#define     RX_BUF_CFG_BUF_NUM_MASK                                              0x700
#define     RX_BUF_CFG_BUF_NUM_SHIFT                                                 8
/* Enable RX DMA operation */
/* 0 : disable RX DMA operation, 1 : enable RX DMA operation */
/* When this field is disabled, */
/* received MPDU is hold in MAC FIFO but not transferred to S/W by DMA */
#define     RX_BUF_CFG_DMA_EN_MASK                                             0x10000
#define     RX_BUF_CFG_DMA_EN_SHIFT                                                 16

#define REG_RX_BUF_PTR0                                                          0x408
/* Ready pointer */
/* RX buffer position where S/W will make new RX Buffer ready */
#define     RX_BUF_PTR0_READY_PTR_MASK                                            0xff
#define     RX_BUF_PTR0_READY_PTR_SHIFT                                              0
/* Read pointer */
/* RX buffer position where S/W will read received MPDU */
#define     RX_BUF_PTR0_READ_PTR_MASK                                         0xff0000
#define     RX_BUF_PTR0_READ_PTR_SHIFT                                              16

#define REG_RX_BUF_PTR1                                                          0x40C
/* Write pointer */
/* RX buffer position where H/W will write received MPDU */
#define     RX_BUF_PTR1_WRITE_PTR_MASK                                            0xff
...
#define REG_RX_DTIM_CFG                                                          0x420
/* Mode for DTIM interrupt */
/* 0 : Always generate interrupt on parsing TIM element */
/* 1 : Generate interrupt on hit of bitmap in TIM element */
/* 2 : Generate interrupt on null of bitmap in TIM element */
#define     RX_DTIM_CFG_DTIM_MODE_MASK                                             0x3
#define     RX_DTIM_CFG_DTIM_MODE_SHIFT                                              0
/* FCS check attribute of interrupt generate */
/* 0 : Generate interrupt as soon as TIM element parsing is done */
/* 1 : Generate interrupt only when FCS check is passed */
/* 2 : Generate interrupt only regardless of FCS check result */
#define     RX_DTIM_CFG_DTIM_FCS_CHECK_MASK                                        0xc
#define     RX_DTIM_CFG_DTIM_FCS_CHECK_SHIFT                                         2
/* Write 1 reset of DTIM module */
#define     RX_DTIM_CFG_DTIM_SOFT_RST_MASK                                  0x80000000
#define     RX_DTIM_CFG_DTIM_SOFT_RST_SHIFT                                         31

#define REG_RX_DTIM_INFO                                                         0x424
/* RX FCS check result */
/* 0 : FCS check is failed */
/* 1 : FCS check is passed */
#define     RX_DTIM_INFO_RX_FCS_MASK                                               0x1
#define     RX_DTIM_INFO_RX_FCS_SHIFT                                                0
/* Indicate RX DTIM our AID bitmap hit */
#define     RX_DTIM_INFO_RX_DTIM_BITMAP_HIT_MASK                                   0x2
#define     RX_DTIM_INFO_RX_DTIM_BITMAP_HIT_SHIFT                                    1
/* Indicate RX DTIM our AID bitmap null or bitmap is not presented */
#define     RX_DTIM_INFO_RX_DTIM_BITMAP_NULL_MASK                                  0x4
#define     RX_DTIM_INFO_RX_DTIM_BITMAP_NULL_SHIFT                                   2
/* Indicate TIM element end before where our AID bitmap should be presented */
#define     RX_DTIM_INFO_RX_DTIM_BITMAP_NULL_UNDER_MASK                            0x8
#define     RX_DTIM_INFO_RX_DTIM_BITMAP_NULL_UNDER_SHIFT                             3
/* Indicate TIM element start after where our AID bitmap should be presented */
#define     RX_DTIM_INFO_RX_DTIM_BITMAP_NULL_ABOVE_MASK                           0x10
#define     RX_DTIM_INFO_RX_DTIM_BITMAP_NULL_ABOVE_SHIFT                             4
/* Indicate whether TIM beacon is DTIM or not */
/* 0 : TIM beacon */
/* 1 : DTIM beacon */
#define     RX_DTIM_INFO_RX_IS_DTIM_MASK                                          0x20
#define     RX_DTIM_INFO_RX_IS_DTIM_SHIFT                                            5
/* Traffic_indicator of bitmap control of DTIM */
#define     RX_DTIM_INFO_RX_TRAFFIC_INDICATOR_MASK                                0x40
#define     RX_DTIM_INFO_RX_TRAFFIC_INDICATOR_SHIFT                                  6
/* Indicate RX DTIM AID0 bitmap value */
#define     RX_DTIM_INFO_RX_DTIM_AID0_BITMAP_HIT_MASK                             0x80
#define     RX_DTIM_INFO_RX_DTIM_AID0_BITMAP_HIT_SHIFT                               7
/* Indicate beacon interval field of rx beacon frame */
#define     RX_DTIM_INFO_RX_BEACON_INTERVAL_MASK                            0xffff0000
#define     RX_DTIM_INFO_RX_BEACON_INTERVAL_SHIFT                                   16
...
/* Index of key memory used for Read/Delete/Add key by index command */
...
/* WN slot time for obss ppdu protocol back trace */
...
/* sw will do register shift in each BEACON time liking OBSS_PD_TX_SRP_NON_SRG_DIS[1:0] <= {OBSS_PD_TX_SRP_NON_SRG_DIS[0],1'b0}. */
...
/* dma bus fsm state */
#define     DBG_DMA_STATE_DMA_BUS_STATE_MASK                                      0x38
#define     DBG_DMA_STATE_DMA_BUS_STATE_SHIFT                                        3
/* dma write cmd fsm state */
#define     DBG_DMA_STATE_DMA_CMD_STATE_MASK                                     0x200
#define     DBG_DMA_STATE_DMA_CMD_STATE_SHIFT                                        9
/* dma fbo fsm state */
#define     DBG_DMA_STATE_DMA_FBO_STATE_MASK                                     0xc00
#define     DBG_DMA_STATE_DMA_FBO_STATE_SHIFT                                       10
/* dma fifo fsm state */
#define     DBG_DMA_STATE_DMA_FIFO_STATE_MASK                                   0x3000
#define     DBG_DMA_STATE_DMA_FIFO_STATE_SHIFT                                      12
...
#define REG_DBG_MUX0                                                             0x8F0
/* MAC debug mux selection signal for bit 0 */
#define     DBG_MUX0_MUX_SEL0_MASK                                                0x1f
#define     DBG_MUX0_MUX_SEL0_SHIFT                                                  0
/* MAC debug mux selection signal for bit 1 */
#define     DBG_MUX0_MUX_SEL1_MASK                                              0x1f00
#define     DBG_MUX0_MUX_SEL1_SHIFT                                                  8
/* MAC debug mux selection signal for bit 2 */
#define     DBG_MUX0_MUX_SEL2_MASK                                            0x1f0000
#define     DBG_MUX0_MUX_SEL2_SHIFT                                                 16
/* MAC debug mux selection signal for bit 3 */
#define     DBG_MUX0_MUX_SEL3_MASK                                          0x1f000000
#define     DBG_MUX0_MUX_SEL3_SHIFT                                                 24

#define REG_DBG_MUX1                                                             0x8F4
/* MAC debug mux selection signal for bit 4 */
#define     DBG_MUX1_MUX_SEL4_MASK                                                0x1f
#define     DBG_MUX1_MUX_SEL4_SHIFT                                                  0
/* MAC debug mux selection signal for bit 5 */
#define     DBG_MUX1_MUX_SEL5_MASK                                              0x1f00
#define     DBG_MUX1_MUX_SEL5_SHIFT                                                  8
/* MAC debug mux selection signal for bit 6 */
#define     DBG_MUX1_MUX_SEL6_MASK                                            0x1f0000
#define     DBG_MUX1_MUX_SEL6_SHIFT                                                 16
/* MAC debug mux selection signal for bit 7 */
#define     DBG_MUX1_MUX_SEL7_MASK                                          0x1f000000
#define     DBG_MUX1_MUX_SEL7_SHIFT                                                 24

#define REG_DBG_MUX2                                                             0x8F8
/* MAC debug mux selection signal for bit 8 */
#define     DBG_MUX2_MUX_SEL8_MASK                                                0x1f
#define     DBG_MUX2_MUX_SEL8_SHIFT                                                  0
/* MAC debug mux selection signal for bit 9 */
#define     DBG_MUX2_MUX_SEL9_MASK                                              0x1f00
#define     DBG_MUX2_MUX_SEL9_SHIFT                                                  8
/* MAC debug mux selection signal for bit 10 */
#define     DBG_MUX2_MUX_SEL10_MASK                                           0x1f0000
#define     DBG_MUX2_MUX_SEL10_SHIFT                                                16
/* MAC debug mux selection signal for bit 11 */
#define     DBG_MUX2_MUX_SEL11_MASK                                         0x1f000000
#define     DBG_MUX2_MUX_SEL11_SHIFT                                                24

#define REG_DBG_MUX3                                                             0x8FC
/* MAC debug mux selection signal for bit 12 */
#define     DBG_MUX3_MUX_SEL12_MASK                                               0x1f
#define     DBG_MUX3_MUX_SEL12_SHIFT                                                 0
/* MAC debug mux selection signal for bit 13 */
#define     DBG_MUX3_MUX_SEL13_MASK                                             0x1f00
#define     DBG_MUX3_MUX_SEL13_SHIFT                                                 8
/* MAC debug mux selection signal for bit 14 */
#define     DBG_MUX3_MUX_SEL14_MASK                                           0x1f0000
#define     DBG_MUX3_MUX_SEL14_SHIFT                                                16
/* MAC debug mux selection signal for bit 15 */
#define     DBG_MUX3_MUX_SEL15_MASK                                         0x1f000000
#define     DBG_MUX3_MUX_SEL15_SHIFT                                                24
#endif /*_MACREGS_H_*/