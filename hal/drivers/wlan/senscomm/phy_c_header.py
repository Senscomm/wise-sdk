...
desc_fname_phy = ["jp_phy_top_regs.rdf", "jp_trx_fe_regs.rdf", "jp_phy_txbe_regs.rdf",
                  "jp_rx_td_regs.rdf", "jp_11b_regs.rdf", "jp_trx_mid_regs.rdf", "jp_phy_rxbe_regs.rdf"];
desc_fname_rfi = ["jp_rfi_cfg_regs.rdf", "jp_rfi_txlut_regs.rdf", "jp_rfi_rxlut_regs.rdf",
                  "jp_rfi_dpmem_regs.rdf"];
desc_fname_all = desc_fname_phy + desc_fname_rfi;

with open("phyregs.h", "w", newline = "") as h_file:
    h_file.write("#ifndef _PHYREGS_H_\n#define _PHYREGS_H_\n")
            ...
            with open(fname) as src_file:
                ...
                for line in src_file:
                    ...
                    if fil_desc.match(line):
                        ...
                        fmask = fname + "_MASK"
                        fshif = fname + "_SHIFT"
                        macro = f"#define     {fmask:44}{hex(mask):>10}\n" \
                                + f"#define     {fshif:44}{pos_b:>10}\n"
    ...
    h_file.write(r"#endif /*_PHYREGS_H_*/")
