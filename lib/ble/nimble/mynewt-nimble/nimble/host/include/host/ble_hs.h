...
struct ble_hs_cfg {
    ...
    /** @brief Security Manager Pairing Disable flag
     *
     **** AYLA ADDITION ****
     *
     * If set, pairing requests will be failed with reason Pairing Not Supported
     * (0x05).
     */
    unsigned sm_no_pairing:1;
    ...
    /** @brief Security Manager Secure Connections only flag
	 */
#ifdef CONFIG_NIMBLE_PTS
