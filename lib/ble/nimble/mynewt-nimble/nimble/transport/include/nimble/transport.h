...
extern __func_tab__ void *(*ble_transport_alloc_cmd)(void);
extern __func_tab__ void *(*ble_transport_alloc_evt)(int discardable);
extern __func_tab__ struct os_mbuf *(*ble_transport_alloc_acl_from_hs)(void);
extern __func_tab__ struct os_mbuf *(*ble_transport_alloc_acl_from_ll)(void);

/* Generic deallocator for cmd/evt buffers */
extern __func_tab__ void (*ble_transport_free)(void *buf);
...
#else
#define ble_transport_to_ll_cmd ble_transport_to_ll_cmd_impl
#define ble_transport_to_ll_acl ble_transport_to_ll_acl_impl
#define ble_transport_to_hs_evt ble_transport_to_hs_evt_impl
#define ble_transport_to_hs_acl ble_transport_to_hs_acl_impl
#endif
