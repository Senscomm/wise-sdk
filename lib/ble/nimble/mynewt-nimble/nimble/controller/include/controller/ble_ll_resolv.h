...
__romfunc__ extern int (*ble_ll_resolv_list_clr)(void);

/* Read the size of the resolving list */
__romfunc__ extern int (*ble_ll_resolv_list_read_size)(uint8_t *rspbuf, uint8_t *rsplen);

/* Add a device to the resolving list */
__romfunc__ extern int (*ble_ll_resolv_list_add)(const uint8_t *cmdbuf, uint8_t len);

/* Remove a device from the resolving list */
__romfunc__ extern int (*ble_ll_resolv_list_rmv)(const uint8_t *cmdbuf, uint8_t len);

/* Address resolution enable command */
__romfunc__ extern int (*ble_ll_resolv_enable_cmd)(const uint8_t *cmdbuf, uint8_t len);

__romfunc__ extern int (*ble_ll_resolv_peer_addr_rd)(const uint8_t *cmdbuf, uint8_t len,
                               uint8_t *rspbuf, uint8_t *rsplen);
__romfunc__ extern int (*ble_ll_resolv_local_addr_rd)(const uint8_t *cmdbuf, uint8_t len,
                                uint8_t *rspbuf, uint8_t *rsplen);

/* Finds 'addr' in resolving list. Doesn't check if address resolution enabled */
struct ble_ll_resolv_entry *
...
__romfunc__ extern void (*ble_ll_resolv_list_reset)(void);
...
__romfunc__ extern int (*ble_ll_resolv_set_rpa_tmo)(const uint8_t *cmdbuf, uint8_t len);

/* Set the privacy mode */
__romfunc__ extern int (*ble_ll_resolve_set_priv_mode)(const uint8_t *cmdbuf, uint8_t len);
...
/* Initialize resolv*/
__romfunc__ extern void (*ble_ll_resolv_init)(void);

#if (SCM2010)
/* Denitialize resolv*/
extern __func_tab__ void (*ble_ll_resolv_deinit)(void);
#endif
