...
__romfunc__ extern void (*ble_ll_ctrl_proc_start)(struct ble_ll_conn_sm *connsm, int ctrl_proc,
                            void *data);
__romfunc__ extern void (*ble_ll_ctrl_proc_stop)(struct ble_ll_conn_sm *connsm, int ctrl_proc);
__romfunc__ extern int (*ble_ll_ctrl_rx_pdu)(struct ble_ll_conn_sm *connsm, struct os_mbuf *om);
__romfunc__ extern void (*ble_ll_ctrl_chk_proc_start)(struct ble_ll_conn_sm *connsm);
__romfunc__ extern void (*ble_ll_ctrl_terminate_start)(struct ble_ll_conn_sm *connsm);
...
__romfunc__ extern int (*ble_ll_ctrl_reject_ind_send)(struct ble_ll_conn_sm *connsm,
                                uint8_t rej_opcode, uint8_t err);
__romfunc__ extern int (*ble_ll_ctrl_start_enc_send)(struct ble_ll_conn_sm *connsm);
int ble_ll_ctrl_enc_allowed_pdu_rx(struct os_mbuf *rxpdu);
__romfunc__ extern int (*ble_ll_ctrl_enc_allowed_pdu_tx)(struct os_mbuf_pkthdr *pkthdr);
__romfunc__ extern int (*ble_ll_ctrl_tx_start)(struct ble_ll_conn_sm *connsm, struct os_mbuf *txpdu);
__romfunc__ extern int (*ble_ll_ctrl_tx_done)(struct os_mbuf *txpdu, struct ble_ll_conn_sm *connsm);
__romfunc__ extern int (*ble_ll_ctrl_is_start_enc_rsp)(struct os_mbuf *txpdu);
