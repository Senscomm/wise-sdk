...
/* Clear the whitelist */
__romfunc__ extern int (*ble_ll_whitelist_clear)(void);

/* Read the size of the whitelist */
__romfunc__ extern int (*ble_ll_whitelist_read_size)(uint8_t *rspbuf, uint8_t *rsplen);

/* Add a device to the whitelist */
__romfunc__ extern int (*ble_ll_whitelist_add)(const uint8_t *cmdbuf, uint8_t len);

/* Remove a device fromthe whitelist */
__romfunc__ extern int (*ble_ll_whitelist_rmv)(const uint8_t *cmdbuf, uint8_t len);
