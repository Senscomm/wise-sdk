...
__romfunc__ extern int (*ble_ll_hci_adv_set_enable)(const uint8_t *cmdbuf, uint8_t len);

/* Set legacy advertising data */
__romfunc__ extern int (*ble_ll_hci_set_adv_data)(const uint8_t *cmdbuf, uint8_t len);

/* Set scan response data */
__romfunc__ extern int (*ble_ll_hci_set_scan_rsp_data)(const uint8_t *cmd, uint8_t cmd_len);

/* Set advertising parameters */
__romfunc__ extern int (*ble_ll_adv_set_adv_params)(const uint8_t *cmdbuf, uint8_t len);

/* Read advertising channel power */
__romfunc__ extern int (*ble_ll_adv_read_txpwr)(uint8_t *rspbuf, uint8_t *rsplen);
...
__romfunc__ extern void (*ble_ll_adv_reset)(void);

/* Called on rx pdu start when in advertising state */
__romfunc__ extern int (*ble_ll_adv_rx_isr_start)(uint8_t pdu_type);

/* Called on rx pdu end when in advertising state */
__romfunc__ extern int (*ble_ll_adv_rx_isr_end)(uint8_t pdu_type, struct os_mbuf *rxpdu, int crcok);

/* Processes received packets at the link layer task */
__romfunc__ extern void (*ble_ll_adv_rx_pkt_in)(uint8_t ptype, uint8_t *rxbuf,
...
__romfunc__ extern void (*ble_ll_adv_halt)(void);

/* Called to determine if advertising is enabled */
uint8_t ble_ll_adv_enabled(void);

__romfunc__ extern int (*ble_ll_adv_hci_set_random_addr)(const uint8_t *cmdbuf, uint8_t len);
int ble_ll_adv_set_random_addr(const uint8_t *addr, uint8_t instance);
__romfunc__ extern int (*ble_ll_adv_remove)(const uint8_t *addr, uint8_t len);
__romfunc__ extern int (*ble_ll_adv_clear_all)(void);
__romfunc__ extern int (*ble_ll_adv_ext_set_param)(const uint8_t *cmdbuf, uint8_t len,
                             uint8_t *rspbuf, uint8_t *rsplen);
__romfunc__ extern int (*ble_ll_adv_ext_set_adv_data)(const uint8_t *cmdbuf, uint8_t cmdlen);
__romfunc__ extern int (*ble_ll_adv_ext_set_scan_rsp)(const uint8_t *cmdbuf, uint8_t cmdlen);
__romfunc__ extern int (*ble_ll_adv_ext_set_enable)(const uint8_t *cmdbuf, uint8_t len);

__romfunc__ extern int (*ble_ll_adv_periodic_set_param)(const uint8_t *cmdbuf, uint8_t len);
__romfunc__ extern int (*ble_ll_adv_periodic_set_data)(const uint8_t *cmdbuf, uint8_t len);
__romfunc__ extern int (*ble_ll_adv_periodic_enable)(const uint8_t *cmdbuf, uint8_t len);

__romfunc__ extern int (*ble_ll_adv_periodic_set_info_transfer)(const uint8_t *cmdbuf, uint8_t len,
                                          uint8_t *rspbuf, uint8_t *rsplen);
