...
__romfunc__ extern void (*ble_ll_conn_sm_new)(struct ble_ll_conn_sm *connsm);
__romfunc__ extern void (*ble_ll_conn_end)(struct ble_ll_conn_sm *connsm, uint8_t ble_err);
__romfunc__ extern void (*ble_ll_conn_enqueue_pkt)(struct ble_ll_conn_sm *connsm, struct os_mbuf *om,
                             uint8_t hdr_byte, uint16_t length);
struct ble_ll_conn_sm *ble_ll_conn_sm_get(void);
__romfunc__ extern void (*ble_ll_conn_central_init)(struct ble_ll_conn_sm *connsm,
...
__romfunc__ extern int (*ble_ll_conn_periph_start)(uint8_t *rxbuf, uint8_t pat,
                            struct ble_mbuf_hdr *rxhdr, bool force_csa2);

/* Link Layer interface */
__romfunc__ extern void (*ble_ll_conn_module_init)(void);
void ble_ll_conn_set_global_chanmap(uint8_t num_used_chans, const uint8_t *chanmap);
__romfunc__ extern void (*ble_ll_conn_module_reset)(void);
...
__romfunc__ extern int (*ble_ll_conn_rx_isr_end)(uint8_t *rxbuf, struct ble_mbuf_hdr *rxhdr);
__romfunc__ extern void (*ble_ll_conn_rx_data_pdu)(struct os_mbuf *rxpdu, struct ble_mbuf_hdr *hdr);
...
__romfunc__ extern void (*ble_ll_conn_event_halt)(void);
/* HCI */
...
__romfunc__ extern int (*ble_ll_conn_hci_create)(const uint8_t *cmdbuf, uint8_t len);
__romfunc__ extern int (*ble_ll_conn_hci_update)(const uint8_t *cmdbuf, uint8_t len);
__romfunc__ extern int (*ble_ll_conn_hci_set_chan_class)(const uint8_t *cmdbuf, uint8_t len);
__romfunc__ extern int (*ble_ll_conn_hci_param_rr)(const uint8_t *cmdbuf, uint8_t len,
                             uint8_t *rspbuf, uint8_t *rsplen);
__romfunc__ extern int (*ble_ll_conn_hci_param_nrr)(const uint8_t *cmdbuf, uint8_t len,
                             uint8_t *rspbuf, uint8_t *rsplen);
__romfunc__ extern int (*ble_ll_conn_create_cancel)(ble_ll_hci_post_cmd_complete_cb *post_cmd_cb);
...
__romfunc__ extern int (*ble_ll_conn_hci_read_rem_features)(const uint8_t *cmdbuf, uint8_t len);
int ble_ll_conn_hci_rd_rssi(const uint8_t *cmdbuf, uint8_t len, uint8_t *rspbuf,
                            uint8_t *rsplen);
__romfunc__ extern int (*ble_ll_conn_hci_rd_chan_map)(const uint8_t *cmdbuf, uint8_t len,
                                uint8_t *rspbuf, uint8_t *rsplen);
__romfunc__ extern int (*ble_ll_conn_hci_set_data_len)(const uint8_t *cmdbuf, uint8_t len,
                                 uint8_t *rspbuf, uint8_t *rsplen);
__romfunc__ extern int (*ble_ll_conn_hci_le_start_encrypt)(const uint8_t *cmdbuf, uint8_t len);
__romfunc__ extern int (*ble_ll_conn_hci_le_ltk_reply)(const uint8_t *cmdbuf, uint8_t len,
                                 uint8_t *rspbuf, uint8_t *rsplen);
__romfunc__ extern int (*ble_ll_conn_hci_le_ltk_neg_reply)(const uint8_t *cmdbuf, uint8_t len,
                                     uint8_t *rspbuf, uint8_t *rsplen);
__romfunc__ extern int (*ble_ll_conn_hci_wr_auth_pyld_tmo)(const uint8_t *cmdbuf, uint8_t len,
                                     uint8_t *rspbuf, uint8_t *rsplen);
__romfunc__ extern int (*ble_ll_conn_hci_rd_auth_pyld_tmo)(const uint8_t *cmdbuf, uint8_t len,
                                     uint8_t *rspbuf, uint8_t *rsplen);
#if MYNEWT_VAL(BLE_LL_CFG_FEAT_LL_SCA_UPDATE)
__rumfunc__ extern int (*ble_ll_conn_req_peer_sca)(const uint8_t *cmdbuf, uint8_t len,
                             uint8_t *rspbuf, uint8_t *rsplen);
#endif
#if MYNEWT_VAL(BLE_LL_CFG_FEAT_LL_ENHANCED_CONN_UPDATE)
...
__romfunc__ extern int (*ble_ll_hci_cmd_rx)(uint8_t *cmd, void *arg);
__romfunc__ extern int (*ble_ll_hci_acl_rx)(struct os_mbuf *om, void *arg);

__romfunc__ extern int (*ble_ll_conn_hci_le_rd_phy)(const uint8_t *cmdbuf, uint8_t len,
                              uint8_t *rsp, uint8_t *rsplen);
__romfunc__ extern int (*ble_ll_conn_hci_le_set_phy)(const uint8_t *cmdbuf, uint8_t len);
int ble_ll_conn_phy_update_if_needed(struct ble_ll_conn_sm *connsm);
#if MYNEWT_VAL(BLE_LL_CFG_FEAT_LL_EXT_ADV)
__romfunc__ extern int (*ble_ll_conn_hci_ext_create)(const uint8_t *cmdbuf, uint8_t len);
#endif

#if MYNEWT_VAL(BLE_LL_CFG_FEAT_LL_PERIODIC_ADV_SYNC_TRANSFER)
__romfunc__ extern int (*ble_ll_set_sync_transfer_params)(const uint8_t *cmdbuf, uint8_t len,
                                    uint8_t *rspbuf, uint8_t *rsplen);
__romfunc__ extern int (*ble_ll_set_default_sync_transfer_params)(const uint8_t *cmdbuf, uint8_t len);
#endif
