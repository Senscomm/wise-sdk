 ...
 */
int _hal_timer_config(int timer_num, uint32_t freq_hz);
extern __func_tab__ int (*hal_timer_config)(int timer_num, uint32_t freq_hz);
 ...
 */
uint32_t _hal_timer_read(int timer_num);
extern __func_tab__ uint32_t (*hal_timer_read)(int timer_num);
 ...
 * @return 0  on success, non-zero error code on failure.
 */
int _hal_timer_set_cb(int timer_num, struct hal_timer *tmr, hal_timer_cb cb_func,
                     void *arg);
extern __func_tab__ int (*hal_timer_set_cb)(int timer_num, struct hal_timer *tmr, hal_timer_cb cb_func,
                     void *arg);
 ...
 * @return 0 on success, non-zero error code on failure.
 */
int _hal_timer_start_at(struct hal_timer *tmr, uint32_t tick);
extern __func_tab__ int (*hal_timer_start_at)(struct hal_timer *tmr, uint32_t tick);
 ...
 */
int _hal_timer_stop(struct hal_timer *tmr);
extern __func_tab__ int (*hal_timer_stop)(struct hal_timer *tmr);
