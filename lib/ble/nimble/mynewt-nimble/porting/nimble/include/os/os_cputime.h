 ...
 */
uint32_t _os_cputime_usecs_to_ticks(uint32_t usecs);
extern __func_tab__ uint32_t (*os_cputime_usecs_to_ticks)(uint32_t usecs);
 ...
 */
uint32_t _os_cputime_ticks_to_usecs(uint32_t ticks);
extern __func_tab__ uint32_t (*os_cputime_ticks_to_usecs)(uint32_t ticks);
#endif
