...
void *
_ble_transport_alloc_cmd(void)
{
    return os_memblock_get(&pool_cmd);
}

#ifdef CONFIG_LINK_TO_ROM
PROVIDE(ble_transport_alloc_cmd, &ble_transport_alloc_cmd, &_ble_transport_alloc_cmd);
#else
__func_tab__ void *(*ble_transport_alloc_cmd)(void)
= _ble_transport_alloc_cmd;
#endif

void *
_ble_transport_alloc_evt(int discardable)
{
    void *buf;
...
#ifdef CONFIG_LINK_TO_ROM
PROVIDE(ble_transport_alloc_evt, &ble_transport_alloc_evt, &_ble_transport_alloc_evt);
#else
__func_tab__ void *(*ble_transport_alloc_evt)(int discardable)
= _ble_transport_alloc_evt;
#endif

struct os_mbuf *
_ble_transport_alloc_acl_from_hs(void)
{
    struct os_mbuf *om;
...
#ifdef CONFIG_LINK_TO_ROM
PROVIDE(ble_transport_alloc_acl_from_hs, &ble_transport_alloc_acl_from_hs, &_ble_transport_alloc_acl_from_hs);
#else
__func_tab__ struct os_mbuf * (*ble_transport_alloc_acl_from_hs)(void)
= _ble_transport_alloc_acl_from_hs;
#endif

struct os_mbuf *
_ble_transport_alloc_acl_from_ll(void)
{
    struct os_mbuf *om;
    struct os_mbuf_pkthdr *pkthdr;
...
#ifdef CONFIG_LINK_TO_ROM
PROVIDE(ble_transport_alloc_acl_from_ll, &ble_transport_alloc_acl_from_ll, &_ble_transport_alloc_acl_from_ll);
#else
__func_tab__ struct os_mbuf * (*ble_transport_alloc_acl_from_ll)(void)
= _ble_transport_alloc_acl_from_ll;
#endif

void
_ble_transport_free(void *buf)
{
...
#ifdef CONFIG_LINK_TO_ROM
PROVIDE(ble_transport_free, &ble_transport_free, &_ble_transport_free);
#else
__func_tab__ void (*ble_transport_free)(void *buf)
= _ble_transport_free;
#endif
