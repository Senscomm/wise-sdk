...
extern void * _ble_transport_alloc_cmd(void);
extern void * _ble_transport_alloc_evt(int discardable);
extern struct os_mbuf * _ble_transport_alloc_acl_from_hs(void);
extern struct os_mbuf * _ble_transport_alloc_acl_from_ll(void);

const struct hci_h4_allocators hci_h4_allocs_from_ll = {
    .acl = _ble_transport_alloc_acl_from_ll,
    .evt = _ble_transport_alloc_evt,
};
const struct hci_h4_allocators hci_h4_allocs_from_hs = {
    .cmd = _ble_transport_alloc_cmd,
    .acl = _ble_transport_alloc_acl_from_hs,
};
