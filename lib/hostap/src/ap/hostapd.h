...
#if defined(__WISE__)
#define STA_HASH_SIZE 1
/* simple hash is enough for a few STAs */
#define STA_HASH(sta) 0
#else
...
#define STA_HASH(sta) (sta[5])
	 ...
	 * 1.
	 */
#if (CONFIG_SUPPORT_STA_NUM > 32)
	#error "CONFIG_SUPPORT_STA_NUM can not be > 32"
#endif
#define AID_WORDS ((CONFIG_SUPPORT_STA_NUM + 31) / 32)
