...
LWIP_MEMPOOL_DUMMY(RAW_PCB)
#endif /* LWIP_RAW */

#if LWIP_UDP
LWIP_MEMPOOL(UDP_PCB,        MEMP_NUM_UDP_PCB,         sizeof(struct udp_pcb),        "UDP_PCB")
#elif defined(__WISE__)
LWIP_MEMPOOL_DUMMY(UDP_PCB)
#endif /* LWIP_UDP */
...
#elif defined(__WISE__)
LWIP_MEMPOOL_DUMMY(NETBUF)
LWIP_MEMPOOL_DUMMY(NETCONN)
...
#elif defined(__WISE__)
LWIP_MEMPOOL_DUMMY(DNS_API_MSG)
#endif
...
#elif defined(__WISE__)
LWIP_MEMPOOL_DUMMY(SOCKET_SETGETSOCKOPT_DATA)
#endif
...
#elif defined(__WISE__)
LWIP_MEMPOOL_DUMMY(NETIFAPI_MSG)
#endif
#elif defined(__WISE__)
LWIP_MEMPOOL_DUMMY(API_MSG)
LWIP_MEMPOOL_DUMMY(DNS_API_MSG)
LWIP_MEMPOOL_DUMMY(SOCKET_SETGETSOCKOPT_DATA)
LWIP_MEMPOOL_DUMMY(SELECT_CB)
LWIP_MEMPOOL_DUMMY(NETIFAPI_MSG)
...
#elif defined(__WISE__)
LWIP_MEMPOOL_DUMMY(TCPIP_MSG_INPKT)
...
#elif defined(__WISE__)
LWIP_MEMPOOL_DUMMY(ARP_QUEUE)
#endif /* LWIP_IPV4 && LWIP_ARP && ARP_QUEUEING */

#if LWIP_IGMP
LWIP_MEMPOOL(IGMP_GROUP,     MEMP_NUM_IGMP_GROUP,      sizeof(struct igmp_group),     "IGMP_GROUP")
#elif defined(__WISE__)
LWIP_MEMPOOL_DUMMY(IGMP_GROUP)
#endif /* LWIP_IGMP */

#if LWIP_TIMERS && !LWIP_TIMERS_CUSTOM
LWIP_MEMPOOL(SYS_TIMEOUT,    MEMP_NUM_SYS_TIMEOUT,     sizeof(struct sys_timeo),      "SYS_TIMEOUT")
#elif defined(__WISE__)
LWIP_MEMPOOL_DUMMY(SYS_TIMEOUT)
#endif /* LWIP_TIMERS && !LWIP_TIMERS_CUSTOM */

#if (LWIP_DNS && LWIP_SOCKET) || defined(__WISE__)
#define NETDB_ELEM_SIZE           (sizeof(struct addrinfo) + sizeof(struct sockaddr_storage) + DNS_MAX_NAME_LENGTH + 1)
LWIP_MEMPOOL(NETDB,          MEMP_NUM_NETDB,           NETDB_ELEM_SIZE,               "NETDB")
#elif defined(__WISE__)
LWIP_MEMPOOL_DUMMY(NETDB)
#endif /* LWIP_DNS && LWIP_SOCKET */
#if LWIP_DNS && DNS_LOCAL_HOSTLIST && DNS_LOCAL_HOSTLIST_IS_DYNAMIC
LWIP_MEMPOOL(LOCALHOSTLIST,  MEMP_NUM_LOCALHOSTLIST,   LOCALHOSTLIST_ELEM_SIZE,       "LOCALHOSTLIST")
#elif defined(__WISE__)
LWIP_MEMPOOL_DUMMY(LOCALHOSTLIST)
#endif /* LWIP_DNS && DNS_LOCAL_HOSTLIST && DNS_LOCAL_HOSTLIST_IS_DYNAMIC */

#if LWIP_IPV6 && LWIP_ND6_QUEUEING
LWIP_MEMPOOL(ND6_QUEUE,      MEMP_NUM_ND6_QUEUE,       sizeof(struct nd6_q_entry),    "ND6_QUEUE")
#elif defined(__WISE__)
LWIP_MEMPOOL_DUMMY(ND6_QUEUE)
