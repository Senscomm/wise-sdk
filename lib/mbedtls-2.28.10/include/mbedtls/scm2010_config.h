/**
 *
 * \brief Default mbedTLS configuration options for SCM2010
 *
...
#ifndef SCM2010_CONFIG_H
#define SCM2010_CONFIG_H

/* XXX: treat it as defaults.
 */
#include "mbedtls/config.h"

/* XXX:
 * Add an option, CONFIG_MBEDTLS_XXX to the lib/mbedtls-2.28.10/library/Kconfig and
 * define or undefine MBEDTLS_XXX based on it.
 */
 ...
 */
#ifdef CONFIG_MBEDTLS_SSL_TLS_C
 ...
 *
  * Allow the X509 parser to not break-off when parsing an X509 certificate
