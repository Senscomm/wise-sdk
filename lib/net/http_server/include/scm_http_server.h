/*
 * Copyright 2024 Senscomm Semiconductor Co., Ltd.	All rights reserved.
 *
...
#ifndef _SCM_HTTP_SERVER_H
#define _SCM_HTTP_SERVER_H
...
#define HTTPD_DEFAULT_CONFIG() {                        \
        .task_priority      = osPriorityNormal,         \
        .stack_size         = 4096,                     \
        .server_port        = 80,                       \
        .ctrl_port          = 32768,                    \
        .max_open_sockets   = 7,                        \
