...
struct iperf_settings
{
    ...
    struct timeval rcv_timeout;  /* Timeout for receiving messages in active mode, in us */
};
...
struct iperf_test
{
    char      role;                             /* 'c' client or 's' server */
    ...
    int       prot_listener;
    /* Timers */
    struct TimerStruct* timers;
    struct TimerStruct* free_timers;
    int iperf3_max_time;
    int iperf3_max_time_cnt;
    int iperf3_max_time_val;
    ...
    struct TimerStruct     *omit_timer;
    struct TimerStruct     *timer;
    int        done;
    struct TimerStruct     *stats_timer;
    struct TimerStruct     *reporter_timer;
