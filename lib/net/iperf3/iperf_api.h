...
#define DEFAULT_TCP_BLKSIZE (8 * 1024)  /* default read/write block size */
#define DEFAULT_SCTP_BLKSIZE (4 * 1024)
#define MAX_UDP_BLKSIZE DEFAULT_TCP_BLKSIZE	/* 4990 : refer IP_REASS_MAX_PBUFS */
...
enum {
    ...
    IETCPBLKSIZE = 901,     // Block size too large. use -l option. Maximum value = %dDEFAULT_TCP_BLKSIZE
    IEUDPBLKSIZE = 902,     // Block size too large. use -l option. Maximum value = %dMAX_UDP_BLKSIZE
};
