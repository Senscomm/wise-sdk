...
typedef osMutexId_t coap_mutex_t;

#define coap_mutex_init(a)    ({*(a) = osMutexNew(NULL);})
#define coap_mutex_destroy(a) osMutexDelete(*(a))
#define coap_mutex_lock(a)    osMutexAcquire(*(a), osWaitForever)
#define coap_mutex_trylock(a) osMutexAcquire(*(a), 0)
#define coap_mutex_unlock(a)  osMutexRelease(*(a))
