...
UBaseType_t uxQueueGetNumberOfTasksWaitingToReceive(const QueueHandle_t xQueue);
UBaseType_t uxQueueGetNumberOfTasksWaitingToReceiveFromISR(const QueueHandle_t xQueue);
