...
#define MATTER_DM_AYLA_BASE_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define MATTER_DM_AYLA_LOCAL_CONTROL_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
// Use this macro to check if the server side of the AylaBase cluster is included
#define ZCL_USING_AYLA_BASE_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_AYLA_BASE_SERVER
#define MATTER_DM_PLUGIN_AYLA_BASE


// Use this macro to check if the server side of the AylaLocalControl cluster is included
#define ZCL_USING_AYLA_LOCAL_CONTROL_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_AYLA_LOCAL_CONTROL_SERVER
#define MATTER_DM_PLUGIN_AYLA_LOCAL_CONTROL
