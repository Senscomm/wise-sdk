 ...
 * DMAC - AE210P AHB
 ****************************************************************************/
#define DMAC_BASE			_IO_(0x00800000) /* Device base address */
 ...
 * UARTx - AE210P
 ****************************************************************************/
#define UART1_BASE			_IO_(0x00602000) /* Device base address */
#define UART2_BASE			_IO_(0x00603000) /* Device base address */
 ...
 * PIT - AE210P
 ****************************************************************************/
#define PIT_BASE0		_IO_(0x00604000) /* Device base address */
#define PIT_BASE1		_IO_(0x00605000) /* Device base address */

#define PIT_BASE			PIT_BASE0 /* Device base address */
 ...
 * WDT - AE210P
 ****************************************************************************/
#define WDTC_BASE			_IO_(0x00606000) /* Device base address */
 ...
 * GPIO - AE210P
 ****************************************************************************/
#define GPIOC_BASE			_IO_(0x00607000) /* Device base address */

/*****************************************************************************
 * I2C - AE210P
 ****************************************************************************/
#define I2C_BASE			_IO_(0x00608000) /* Device base address */

/*****************************************************************************
 * SPI1 - AE210P
 ****************************************************************************/
#define SPI1_BASE			_IO_(0x00609000) /* Device base address */

/*****************************************************************************
 * I2S/AC97 - AE210P (SSP2)
 ****************************************************************************/
#define SPI2_BASE			_IO_(0x0060a000) /* Device base address */
...
#define BOOTMODE_BASE		(0x00601808)
...
#define PIN0_MUX_BASE		0x00601824
#define PIN1_MUX_BASE		0x00601828
#define CLK_DBB		        0x00601CAC
#define PS_HOLD             0x0060100c
...
#define CLK_ENABLE(x)	OUT32(CLK_EN_BASE, IN32(CLK_EN_BASE) | (x))
