...
#define	ETHERTYPE_VARIAN	0x80DD	/* Variant Associates */
...
#define ETHERTYPE_P_LINK_CTL	0x886c		/* HPNA, wlan link local tunnel */
...
void _ether_ifattach(struct ifnet *ifp, const uint8_t *lla);
extern	void (*ether_ifattach)(struct ifnet *, const u_int8_t *);
extern	void ether_ifdetach(struct ifnet *);
int _ether_ioctl(struct ifnet *ifp, u_long command, caddr_t data);
extern int (*ether_ioctl)(struct ifnet *ifp, u_long command, caddr_t data);
extern	int  ether_output(struct ifnet *,
		   struct mbuf *, const struct sockaddr *, struct route *);
